...
![MingJie 登录页](docs/screenshots/login.png?v=202607161)

### 仪表盘

![MingJie 仪表盘](docs/screenshots/dashboard.png?v=202607161)

### 库表数据列表

![MingJie 库表数据列表](docs/screenshots/data-overview-fields.png?v=202607161)

### 数据资产发现

![MingJie 数据资产发现](docs/screenshots/data-asset-discovery.png?v=202607161)

### 分类分级模板

![MingJie 分类分级模板](docs/screenshots/classification-template.png?v=202607161)
